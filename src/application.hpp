...
private:
    ...
    Workers workers { 2 };
    Workers directoryWorkers { 2 };
    std::atomic_bool stopping { false };
    std::atomic_uint64_t browseGeneration { 0 };
    std::atomic_uint64_t rootGeneration { 0 };
    std::atomic_uint64_t treeFolders { 0 };
    ...
    double gpuBudgetMB = 4000;
    double viewerBudgetMB = 2300;
    uint64_t cpuCacheBudget = 1000000000;
    uint64_t gpuCacheBudget = 400000000;
    std::string status;
